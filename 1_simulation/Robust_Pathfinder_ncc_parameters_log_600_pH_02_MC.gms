...
**  - the Monte Carlo simulation with a constraint limiting ocean acidification to a pH variation of 0.2 since the preindustrial era
...
$offecho
$call gdxxrw i=par_v1_02pH_MC.xlsx o=par_m.gdx @par_m.tab
...
$offecho
$call gdxxrw i=ini_2015_v1_02pH_MC.xlsx o=ini_m.gdx @ini_m.tab
...
$offecho
$call gdxxrw i=ERFx_for_dice_2_02pH_MC.xlsx o=ERFx_for_dice.gdx @ERFx_for_dice.tab
...
$offecho
$call gdxxrw i=Eluc_for_dice_2_02pH_MC.xlsx o=Eluc_for_dice.gdx @Eluc_for_dice.tab
...
equation pH_min_eq1, utility_ph_eq1; variable limpH, Utility_pH1; scalar penpH1, tarpH1;
pH_min_eq1(t)..        pH1(t)        =G= limpH ;
utility_ph_eq1..       Utility_pH1   =E= Utility1 - penpH1* Power(limpH - tarpH1, 2);
model NizzapH / Nizza + pH_min_eq1 + utility_ph_eq1/ ;
model NizzapHramp / NizzapH, Ramp1 / ;
...
* Setting penalty for variation of pH bellow 0.2 since preindustrial era
penpH1=10**9;
penA1 =0;
tarA1 = inf;
targ_pH(m) = pH_pi(m) - 0.2;


a2d_var1.fx = 0;

** parameter to ease the optimization in the second round
parameter pHmin1;
...
If((ifmod eq 1), solve NizzapHRamp maxmizing Utility_pH1 using nlp;
else             solve NizzapH maxmizing Utility_pH1 using nlp;
);
If((ifmod eq 1), solve NizzapHRamp maxmizing Utility_pH1 using nlp;
else             solve NizzapH maxmizing Utility_pH1 using nlp;
);
...
pHmin1 = smin(t, pH1.l(t));

pH1.lo(t) = min(tarpH1, pHmin1);

If((ifmod eq 1), solve NizzaRamp maxmizing Utility1 using nlp;
else             solve Nizza maxmizing Utility1 using nlp;
);
...
optsol(m) = NizzapHRamp.modelstat$(ifmod eq 1) + nizzapH.modelstat$(ifmod eq 0) ;
...
execute_unload "resultsMC02pH.gdx"
execute 'gdxxrw.exe resultsMC02pH.gdx o=resultsMC02pH.xlsx text="Damage Parameter" rng=stats!a3 var=a2d_var.l rng=stats!b3 text="Solution status" rng=stats!a4 par=solstat rng=stats!b4 text="modified DICE (yes if 1)" rng=stats!a5 par=ifmod rng=stats!b5 text="population" rng=stats!a6 par=l rng=stats!b6 ' ;
execute 'gdxxrw.exe resultsMC02pH.gdx o=resultsMC02pH.xlsx var=Eind.l rng=Eind!a1 text="Eind" rng=Eind!A1 par=Etree rng=Etree!a1 text="Etree" rng=Etree!A1 var=ECO2.l rng=ECO2!a1 text="ECO2" rng=ECO2!A1 var=Fland.l rng=Fland!a1 text="Fland" rng=Fland!A1  var=Focean.l rng=Focean!a1 text="Focean" rng=Focean!A1 var=Epf.l rng=Epf!a1 text="Epf" rng=Epf!A1 var=Co2.l rng=Co2!a1 text="Co2" rng=Co2!A1 var=Co2_dot.l rng=Co2_dot!a1 text="Co2_dot" rng=Co2_dot!A1';
execute 'gdxxrw.exe resultsMC02pH.gdx o=resultsMC02pH.xlsx var=RFCO2.l rng=RFCO2!a1 text="RFCO2" rng=RFCO2!A1 par=ERFx rng=ERFx!a1 text="ERFx" rng=ERFx!A1 var=ERF.l rng=ERF!a1 text="ERF" rng=ERF!A1';
execute 'gdxxrw.exe resultsMC02pH.gdx o=resultsMC02pH.xlsx var=miu.l rng=miu!a1 text="miu" rng=miu!A1  var=C.l rng=C!a1 text="C" rng=C!A1  var=Y.l rng=Y!a1 text="Y" rng=Y!A1  var=Kd.l rng=Kd!a1 text="Kd" rng=Kd!A1 var=Y.l rng=Y!a1 text="Y" rng=Y!A1';
execute 'gdxxrw.exe resultsMC02pH.gdx o=resultsMC02pH.xlsx var=Tatm.l rng=Tatm!a1 text="Tatm" rng=Tatm!A1  var=pH.l rng=pH!a1 text="pH" rng=pH!A1 var=a.l rng=a!a1 text="a" rng=a!A1 var=Td.l rng=Td!a1 text="Td" rng=Td!A1 var=T_dot.l rng=T_dot!a1 text="T_dot" rng=T_dot!A1 var=Td_dot.l rng=Td_dot!a1 text="Td_dot" rng=Td_dot!A1' ;
execute 'gdxxrw.exe resultsMC02pH.gdx o=resultsMC02pH.xlsx var=OHC.l rng=OHC!a1 text="OHC" rng=OHC!A1 var=OHC_dot.l rng=OHC_dot!a1 text="OHC_dot" rng=OHC_dot!A1 var=Hthx_dot.l rng=Hthx_dot!a1 text="Hthx_dot" rng=Hthx_dot!A1 var=Hgla_dot.l rng=Hgla_dot!a1 text="Hgla_dot" rng=Hgla_dot!A1 var=Hgis_dot.l rng=Hgis_dot!a1 text="Hgis_dot" rng=Hgis_dot!A1 var=Hais_dot.l rng=Hais_dot!a1 text="Hais_dot" rng=Hais_dot!A1 var=Hais_smb_dot.l rng=Hais_smb_dot!a1 text="Hais_smb_dot" rng=Hais_smb_dot!A1 var=Htot_dot.l rng=Htot_dot!a1 text="Htot_dot" rng=Htot_dot!A1 var=Hthx.l rng=Hthx!a1 text="Hthx" rng=Hthx!A1 var=Hgla.l rng=Hgla!a1 text="Hgla" rng=Hgla!A1 var=Hgis.l rng=Hgis!a1 text="Hgis" rng=Hgis!A1 var=Hais.l rng=Hais!a1 text="Hais" rng=Hais!A1 var=Hais_smb.l rng=Hais_smb!a1 text="Hais_smb" rng=Hais_smb!A1 var=Htot.l rng=Htot!a1 text="Htot" rng=Htot!A1' ;
execute 'gdxxrw.exe resultsMC02pH.gdx o=resultsMC02pH.xlsx par=lambdaC rng=lambdaC!a1 text="lambdaC" rng=lambdaC!A1  par=lambdaE rng=lambdaE!a1 text="lambdaE" rng=lambdaE!A1  par=Cprice rng=Cprice!a1 text="Cprice" rng=Cprice!A1  par=SCC rng=SCC!a1 text="false SCC" rng=SCC!A1  par=FOCuniC rng=FOCuniC!a1 text="FOCuniC" rng=FOCuniC!A1  par=FOCuniMIU rng=FOCuniMIU!a1 text="FOCuniMIU" rng=FOCuniMIU!A1  par=FOClambda rng=FOClambda!a1 text="FOClambda" rng=FOClambda!A1 par=mutil rng=marg_util!a1 text="marginal utility" rng=marg_util!A1' ;
execute 'gdxxrw.exe resultsMC02pH.gdx o=resultsMC02pH.xlsx var=utility.l rng=utility!a1 text="Utility" rng=utility!A1  var=Metautility.l rng=Metautility!a2 text="Metautility" rng=Metautility!A1' ;
execute 'gdxxrw.exe resultsMC02pH.gdx o=resultsMC02pH.xlsx par=pH_pi rng=pH_pi!a1 text="pH_pi" rng=pH_pi!A1' ;
