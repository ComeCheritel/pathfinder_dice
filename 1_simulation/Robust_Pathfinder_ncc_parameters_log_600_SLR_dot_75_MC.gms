...
**  - the Monte Carlo simulation with a constraint limiting sea-level rise speed to 7.5 mm per year
...
$offecho
$call gdxxrw i=par_v1_75SLR_dot_MC.xlsx o=par_m.gdx @par_m.tab
...
$offecho
$call gdxxrw i=ini_2015_v1_75SLR_dot_MC.xlsx o=ini_m.gdx @ini_m.tab
...
$offecho
$call gdxxrw i=ERFx_for_dice_2_75SLR_dot_MC.xlsx o=ERFx_for_dice.gdx @ERFx_for_dice.tab
...
$offecho
$call gdxxrw i=Eluc_for_dice_2_75SLR_dot_MC.xlsx o=Eluc_for_dice.gdx @Eluc_for_dice.tab
...
alpha = 50; targ_temp = 2.0; targ_a = 0.3;
pen_temp = 0;
...
equation SLR_dot_eq1, utility_SLR_dot_eq1; variable limSLR_dot, Utility_SLR_dot1; scalar penSLR_dot1, tarSLR_dot1;
SLR_dot_eq1(t)..            Htot_dot1(t)        =L= limSLR_dot ;
utility_SLR_dot_eq1..       Utility_SLR_dot1   =E= Utility1 - penSLR_dot1* Power(limSLR_dot - tarSLR_dot1, 2);
model NizzaSLR_dot / Nizza + SLR_dot_eq1 + utility_SLR_dot_eq1/ ;
model NizzaSLR_dotramp / NizzaSLR_dot, Ramp1 / ;
...
** setting penalty paramers for sea-level rise speed above 7.5 mm/year
penSLR_dot1=10**9; tarSLR_dot1 = 7.5 ;
...
If((ifmod eq 1), solve NizzaSLR_dotRamp maxmizing utility_SLR_dot1 using nlp;
else             solve NizzaSLR_dot maxmizing utility_SLR_dot1 using nlp;
);
If((ifmod eq 1), solve NizzaSLR_dotRamp maxmizing utility_SLR_dot1 using nlp;
else             solve NizzaSLR_dot maxmizing utility_SLR_dot1 using nlp;
);
...
optsol(m) = NizzaSLR_dotRamp.modelstat$(ifmod eq 1) + NizzaSLR_dot.modelstat$(ifmod eq 0) ;
...
File NiceSSLR_dot75 /NiceSSLR_dot75.txt/;
NiceSSLR_dot75.pc=5;
NiceSSLR_dot75.pw=32767;
Put NiceSSLR_dot75;
...
parameter SLR_dotmax, SLR_dotmaxmax;
SLR_dotmax(m) = smax(t, Htot_dot.l(m,t));
SLR_dotmaxmax = smax(m, SLR_dotmax(m));
display SLR_dotmax, SLR_dotmaxmax;

Htot_dot.up(m,t) = max(7.5, SLR_dotmax(m));
