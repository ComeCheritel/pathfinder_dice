...
**  - the Monte Carlo simulation with a constraint limiting permafrost thawing to 30%
...
$offecho
$call gdxxrw i=par_v1_03A_MC.xlsx o=par_m.gdx @par_m.tab
...
$offecho
$call gdxxrw i=ini_2015_v1_03A_MC.xlsx o=ini_m.gdx @ini_m.tab
...
$offecho
$call gdxxrw i=ERFx_for_dice_2_03A_MC.xlsx o=ERFx_for_dice.gdx @ERFx_for_dice.tab
...
$offecho
$call gdxxrw i=Eluc_for_dice_2_03A_MC.xlsx o=Eluc_for_dice.gdx @Eluc_for_dice.tab
...
** setting penalty paramers for thawing of permafrost above 30%
penA1=10**9; tarA1 = 0.3 ;
