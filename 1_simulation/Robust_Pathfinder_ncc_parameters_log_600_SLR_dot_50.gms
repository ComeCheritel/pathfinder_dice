...
**  - the robust probabilistic simulations with a constraint limiting sea-level rise to 5.0 mm per year
...
** Htot_dot < 5mm probabilistic target
** 95%


targ_HtotDot = 5.0;   pen_HtotDot = 10**8;
prob_targ = 1 - 95/100;
...
If((ifmod eq 1), solve METAmajorSLRdotRamp maximize MetaUTILITY using NLP; solstat = METAmajorSLRdot.modelstat ;
...
execute_unload "results50SLRdot90.gdx"
execute 'gdxxrw.exe results50SLRdot90.gdx o=results50SLRdot90.xlsx text="Target Probability of staying below" rng=stats!a1 text="0.95" rng=stats!b1 text="Actual probability of staying below, Temp" rng=stats!a2 var=MaxTempCon.l rng=stats!b2 text="Actual probability of staying below, A" rng=stats!a3 var=MaxACon.l rng=stats!b3 text="Actual probability of staying below, pH" rng=stats!a4 var=MinpHCon.l rng=stats!b4 text="Damage Parameter" rng=stats!a5 var=a2d_var.l rng=stats!b5 text="Solution status" rng=stats!a6 par=solstat rng=stats!b6 text="modified DICE (yes if 1)" rng=stats!a7 par=ifmod rng=stats!b7 ' ;
execute 'gdxxrw.exe results50SLRdot90.gdx o=results50SLRdot90.xlsx var=Eind.l rng=Eind!a1 text="Eind" rng=Eind!A1 par=Etree rng=Etree!a1 text="Etree" rng=Etree!A1 var=ECO2.l rng=ECO2!a1 text="ECO2" rng=ECO2!A1 var=Fland.l rng=Fland!a1 text="Fland" rng=Fland!A1  var=Focean.l rng=Focean!a1 text="Focean" rng=Focean!A1 var=Epf.l rng=Epf!a1 text="Epf" rng=Epf!A1 var=Co2.l rng=Co2!a1 text="Co2" rng=Co2!A1 var=Co2_dot.l rng=Co2_dot!a1 text="Co2_dot" rng=Co2_dot!A1';
execute 'gdxxrw.exe results50SLRdot90.gdx o=results50SLRdot90.xlsx var=RFCO2.l rng=RFCO2!a1 text="RFCO2" rng=RFCO2!A1 par=ERFx rng=ERFx!a1 text="ERFx" rng=ERFx!A1 var=ERF.l rng=ERF!a1 text="ERF" rng=ERF!A1';
execute 'gdxxrw.exe results50SLRdot90.gdx o=results50SLRdot90.xlsx var=miu.l rng=miu!a1 text="miu" rng=miu!A1  var=C.l rng=C!a1 text="C" rng=C!A1  var=Y.l rng=Y!a1 text="Y" rng=Y!A1  var=Kd.l rng=Kd!a1 text="Kd" rng=Kd!A1 var=Y.l rng=Y!a1 text="Y" rng=Y!A1';
execute 'gdxxrw.exe results50SLRdot90.gdx o=results50SLRdot90.xlsx var=Tatm.l rng=Tatm!a1 text="Tatm" rng=Tatm!A1  var=pH.l rng=pH!a1 text="pH" rng=pH!A1 var=a.l rng=a!a1 text="a" rng=a!A1 var=Td.l rng=Td!a1 text="Td" rng=Td!A1 var=T_dot.l rng=T_dot!a1 text="T_dot" rng=T_dot!A1 var=Td_dot.l rng=Td_dot!a1 text="Td_dot" rng=Td_dot!A1' ;
execute 'gdxxrw.exe results50SLRdot90.gdx o=results50SLRdot90.xlsx var=OHC.l rng=OHC!a1 text="OHC" rng=OHC!A1 var=OHC_dot.l rng=OHC_dot!a1 text="OHC_dot" rng=OHC_dot!A1 var=Hthx_dot.l rng=Hthx_dot!a1 text="Hthx_dot" rng=Hthx_dot!A1 var=Hgla_dot.l rng=Hgla_dot!a1 text="Hgla_dot" rng=Hgla_dot!A1 var=Hgis_dot.l rng=Hgis_dot!a1 text="Hgis_dot" rng=Hgis_dot!A1 var=Hais_dot.l rng=Hais_dot!a1 text="Hais_dot" rng=Hais_dot!A1 var=Hais_smb_dot.l rng=Hais_smb_dot!a1 text="Hais_smb_dot" rng=Hais_smb_dot!A1 var=Htot_dot.l rng=Htot_dot!a1 text="Htot_dot" rng=Htot_dot!A1 var=Hthx.l rng=Hthx!a1 text="Hthx" rng=Hthx!A1 var=Hgla.l rng=Hgla!a1 text="Hgla" rng=Hgla!A1 var=Hgis.l rng=Hgis!a1 text="Hgis" rng=Hgis!A1 var=Hais.l rng=Hais!a1 text="Hais" rng=Hais!A1 var=Hais_smb.l rng=Hais_smb!a1 text="Hais_smb" rng=Hais_smb!A1 var=Htot.l rng=Htot!a1 text="Htot" rng=Htot!A1' ;
execute 'gdxxrw.exe results50SLRdot90.gdx o=results50SLRdot90.xlsx par=lambdaC rng=lambdaC!a1 text="lambdaC" rng=lambdaC!A1  par=lambdaE rng=lambdaE!a1 text="lambdaE" rng=lambdaE!A1  par=Cprice rng=Cprice!a1 text="Cprice" rng=Cprice!A1  par=SCC rng=SCC!a1 text="false SCC" rng=SCC!A1  par=FOCuniC rng=FOCuniC!a1 text="FOCuniC" rng=FOCuniC!A1  par=FOCuniMIU rng=FOCuniMIU!a1 text="FOCuniMIU" rng=FOCuniMIU!A1  par=FOClambda rng=FOClambda!a1 text="FOClambda" rng=FOClambda!A1 par=mutil rng=marg_util!a1 text="marginal utility" rng=marg_util!A1' ;
execute 'gdxxrw.exe results50SLRdot90.gdx o=results50SLRdot90.xlsx var=utility.l rng=utility!a1 text="Utility" rng=utility!A1  var=Metautility.l rng=Metautility!a2 text="Metautility" rng=Metautility!A1' ;
...
execute_unload "results50SLRdot66.gdx"
execute 'gdxxrw.exe results50SLRdot66.gdx o=results50SLRdot66.xlsx text="Target Probability of staying below" rng=stats!a1 text="0.95" rng=stats!b1 text="Actual probability of staying below, Temp" rng=stats!a2 var=MaxTempCon.l rng=stats!b2 text="Actual probability of staying below, A" rng=stats!a3 var=MaxACon.l rng=stats!b3 text="Actual probability of staying below, pH" rng=stats!a4 var=MinpHCon.l rng=stats!b4 text="Damage Parameter" rng=stats!a5 var=a2d_var.l rng=stats!b5 text="Solution status" rng=stats!a6 par=solstat rng=stats!b6 text="modified DICE (yes if 1)" rng=stats!a7 par=ifmod rng=stats!b7 ' ;
execute 'gdxxrw.exe results50SLRdot66.gdx o=results50SLRdot66.xlsx var=Eind.l rng=Eind!a1 text="Eind" rng=Eind!A1 par=Etree rng=Etree!a1 text="Etree" rng=Etree!A1 var=ECO2.l rng=ECO2!a1 text="ECO2" rng=ECO2!A1 var=Fland.l rng=Fland!a1 text="Fland" rng=Fland!A1  var=Focean.l rng=Focean!a1 text="Focean" rng=Focean!A1 var=Epf.l rng=Epf!a1 text="Epf" rng=Epf!A1 var=Co2.l rng=Co2!a1 text="Co2" rng=Co2!A1 var=Co2_dot.l rng=Co2_dot!a1 text="Co2_dot" rng=Co2_dot!A1';
execute 'gdxxrw.exe results50SLRdot66.gdx o=results50SLRdot66.xlsx var=RFCO2.l rng=RFCO2!a1 text="RFCO2" rng=RFCO2!A1 par=ERFx rng=ERFx!a1 text="ERFx" rng=ERFx!A1 var=ERF.l rng=ERF!a1 text="ERF" rng=ERF!A1';
execute 'gdxxrw.exe results50SLRdot66.gdx o=results50SLRdot66.xlsx var=miu.l rng=miu!a1 text="miu" rng=miu!A1  var=C.l rng=C!a1 text="C" rng=C!A1  var=Y.l rng=Y!a1 text="Y" rng=Y!A1  var=Kd.l rng=Kd!a1 text="Kd" rng=Kd!A1 var=Y.l rng=Y!a1 text="Y" rng=Y!A1';
execute 'gdxxrw.exe results50SLRdot66.gdx o=results50SLRdot66.xlsx var=Tatm.l rng=Tatm!a1 text="Tatm" rng=Tatm!A1  var=pH.l rng=pH!a1 text="pH" rng=pH!A1 var=a.l rng=a!a1 text="a" rng=a!A1 var=Td.l rng=Td!a1 text="Td" rng=Td!A1 var=T_dot.l rng=T_dot!a1 text="T_dot" rng=T_dot!A1 var=Td_dot.l rng=Td_dot!a1 text="Td_dot" rng=Td_dot!A1' ;
execute 'gdxxrw.exe results50SLRdot66.gdx o=results50SLRdot66.xlsx var=OHC.l rng=OHC!a1 text="OHC" rng=OHC!A1 var=OHC_dot.l rng=OHC_dot!a1 text="OHC_dot" rng=OHC_dot!A1 var=Hthx_dot.l rng=Hthx_dot!a1 text="Hthx_dot" rng=Hthx_dot!A1 var=Hgla_dot.l rng=Hgla_dot!a1 text="Hgla_dot" rng=Hgla_dot!A1 var=Hgis_dot.l rng=Hgis_dot!a1 text="Hgis_dot" rng=Hgis_dot!A1 var=Hais_dot.l rng=Hais_dot!a1 text="Hais_dot" rng=Hais_dot!A1 var=Hais_smb_dot.l rng=Hais_smb_dot!a1 text="Hais_smb_dot" rng=Hais_smb_dot!A1 var=Htot_dot.l rng=Htot_dot!a1 text="Htot_dot" rng=Htot_dot!A1 var=Hthx.l rng=Hthx!a1 text="Hthx" rng=Hthx!A1 var=Hgla.l rng=Hgla!a1 text="Hgla" rng=Hgla!A1 var=Hgis.l rng=Hgis!a1 text="Hgis" rng=Hgis!A1 var=Hais.l rng=Hais!a1 text="Hais" rng=Hais!A1 var=Hais_smb.l rng=Hais_smb!a1 text="Hais_smb" rng=Hais_smb!A1 var=Htot.l rng=Htot!a1 text="Htot" rng=Htot!A1' ;
execute 'gdxxrw.exe results50SLRdot66.gdx o=results50SLRdot66.xlsx par=lambdaC rng=lambdaC!a1 text="lambdaC" rng=lambdaC!A1  par=lambdaE rng=lambdaE!a1 text="lambdaE" rng=lambdaE!A1  par=Cprice rng=Cprice!a1 text="Cprice" rng=Cprice!A1  par=SCC rng=SCC!a1 text="false SCC" rng=SCC!A1  par=FOCuniC rng=FOCuniC!a1 text="FOCuniC" rng=FOCuniC!A1  par=FOCuniMIU rng=FOCuniMIU!a1 text="FOCuniMIU" rng=FOCuniMIU!A1  par=FOClambda rng=FOClambda!a1 text="FOClambda" rng=FOClambda!A1 par=mutil rng=marg_util!a1 text="marginal utility" rng=marg_util!A1' ;
execute 'gdxxrw.exe results50SLRdot66.gdx o=results50SLRdot66.xlsx var=utility.l rng=utility!a1 text="Utility" rng=utility!A1  var=Metautility.l rng=Metautility!a2 text="Metautility" rng=Metautility!A1' ;
...
execute_unload "results50SLRdot50.gdx"
execute 'gdxxrw.exe results50SLRdot50.gdx o=results50SLRdot50.xlsx text="Target Probability of staying below" rng=stats!a1 text="0.95" rng=stats!b1 text="Actual probability of staying below, Temp" rng=stats!a2 var=MaxTempCon.l rng=stats!b2 text="Actual probability of staying below, A" rng=stats!a3 var=MaxACon.l rng=stats!b3 text="Actual probability of staying below, pH" rng=stats!a4 var=MinpHCon.l rng=stats!b4 text="Damage Parameter" rng=stats!a5 var=a2d_var.l rng=stats!b5 text="Solution status" rng=stats!a6 par=solstat rng=stats!b6 text="modified DICE (yes if 1)" rng=stats!a7 par=ifmod rng=stats!b7 ' ;
execute 'gdxxrw.exe results50SLRdot50.gdx o=results50SLRdot50.xlsx var=Eind.l rng=Eind!a1 text="Eind" rng=Eind!A1 par=Etree rng=Etree!a1 text="Etree" rng=Etree!A1 var=ECO2.l rng=ECO2!a1 text="ECO2" rng=ECO2!A1 var=Fland.l rng=Fland!a1 text="Fland" rng=Fland!A1  var=Focean.l rng=Focean!a1 text="Focean" rng=Focean!A1 var=Epf.l rng=Epf!a1 text="Epf" rng=Epf!A1 var=Co2.l rng=Co2!a1 text="Co2" rng=Co2!A1 var=Co2_dot.l rng=Co2_dot!a1 text="Co2_dot" rng=Co2_dot!A1';
execute 'gdxxrw.exe results50SLRdot50.gdx o=results50SLRdot50.xlsx var=RFCO2.l rng=RFCO2!a1 text="RFCO2" rng=RFCO2!A1 par=ERFx rng=ERFx!a1 text="ERFx" rng=ERFx!A1 var=ERF.l rng=ERF!a1 text="ERF" rng=ERF!A1';
execute 'gdxxrw.exe results50SLRdot50.gdx o=results50SLRdot50.xlsx var=miu.l rng=miu!a1 text="miu" rng=miu!A1  var=C.l rng=C!a1 text="C" rng=C!A1  var=Y.l rng=Y!a1 text="Y" rng=Y!A1  var=Kd.l rng=Kd!a1 text="Kd" rng=Kd!A1 var=Y.l rng=Y!a1 text="Y" rng=Y!A1';
execute 'gdxxrw.exe results50SLRdot50.gdx o=results50SLRdot50.xlsx var=Tatm.l rng=Tatm!a1 text="Tatm" rng=Tatm!A1  var=pH.l rng=pH!a1 text="pH" rng=pH!A1 var=a.l rng=a!a1 text="a" rng=a!A1 var=Td.l rng=Td!a1 text="Td" rng=Td!A1 var=T_dot.l rng=T_dot!a1 text="T_dot" rng=T_dot!A1 var=Td_dot.l rng=Td_dot!a1 text="Td_dot" rng=Td_dot!A1' ;
execute 'gdxxrw.exe results50SLRdot50.gdx o=results50SLRdot50.xlsx var=OHC.l rng=OHC!a1 text="OHC" rng=OHC!A1 var=OHC_dot.l rng=OHC_dot!a1 text="OHC_dot" rng=OHC_dot!A1 var=Hthx_dot.l rng=Hthx_dot!a1 text="Hthx_dot" rng=Hthx_dot!A1 var=Hgla_dot.l rng=Hgla_dot!a1 text="Hgla_dot" rng=Hgla_dot!A1 var=Hgis_dot.l rng=Hgis_dot!a1 text="Hgis_dot" rng=Hgis_dot!A1 var=Hais_dot.l rng=Hais_dot!a1 text="Hais_dot" rng=Hais_dot!A1 var=Hais_smb_dot.l rng=Hais_smb_dot!a1 text="Hais_smb_dot" rng=Hais_smb_dot!A1 var=Htot_dot.l rng=Htot_dot!a1 text="Htot_dot" rng=Htot_dot!A1 var=Hthx.l rng=Hthx!a1 text="Hthx" rng=Hthx!A1 var=Hgla.l rng=Hgla!a1 text="Hgla" rng=Hgla!A1 var=Hgis.l rng=Hgis!a1 text="Hgis" rng=Hgis!A1 var=Hais.l rng=Hais!a1 text="Hais" rng=Hais!A1 var=Hais_smb.l rng=Hais_smb!a1 text="Hais_smb" rng=Hais_smb!A1 var=Htot.l rng=Htot!a1 text="Htot" rng=Htot!A1' ;
execute 'gdxxrw.exe results50SLRdot50.gdx o=results50SLRdot50.xlsx par=lambdaC rng=lambdaC!a1 text="lambdaC" rng=lambdaC!A1  par=lambdaE rng=lambdaE!a1 text="lambdaE" rng=lambdaE!A1  par=Cprice rng=Cprice!a1 text="Cprice" rng=Cprice!A1  par=SCC rng=SCC!a1 text="false SCC" rng=SCC!A1  par=FOCuniC rng=FOCuniC!a1 text="FOCuniC" rng=FOCuniC!A1  par=FOCuniMIU rng=FOCuniMIU!a1 text="FOCuniMIU" rng=FOCuniMIU!A1  par=FOClambda rng=FOClambda!a1 text="FOClambda" rng=FOClambda!A1 par=mutil rng=marg_util!a1 text="marginal utility" rng=marg_util!A1' ;
execute 'gdxxrw.exe results50SLRdot50.gdx o=results50SLRdot50.xlsx var=utility.l rng=utility!a1 text="Utility" rng=utility!A1  var=Metautility.l rng=Metautility!a2 text="Metautility" rng=Metautility!A1' ;
...
execute_unload "results50SLRdot33.gdx"
execute 'gdxxrw.exe results50SLRdot33.gdx o=results50SLRdot33.xlsx text="Target Probability of staying below" rng=stats!a1 text="0.95" rng=stats!b1 text="Actual probability of staying below, Temp" rng=stats!a2 var=MaxTempCon.l rng=stats!b2 text="Actual probability of staying below, A" rng=stats!a3 var=MaxACon.l rng=stats!b3 text="Actual probability of staying below, pH" rng=stats!a4 var=MinpHCon.l rng=stats!b4 text="Damage Parameter" rng=stats!a5 var=a2d_var.l rng=stats!b5 text="Solution status" rng=stats!a6 par=solstat rng=stats!b6 text="modified DICE (yes if 1)" rng=stats!a7 par=ifmod rng=stats!b7 ' ;
execute 'gdxxrw.exe results50SLRdot33.gdx o=results50SLRdot33.xlsx var=Eind.l rng=Eind!a1 text="Eind" rng=Eind!A1 par=Etree rng=Etree!a1 text="Etree" rng=Etree!A1 var=ECO2.l rng=ECO2!a1 text="ECO2" rng=ECO2!A1 var=Fland.l rng=Fland!a1 text="Fland" rng=Fland!A1  var=Focean.l rng=Focean!a1 text="Focean" rng=Focean!A1 var=Epf.l rng=Epf!a1 text="Epf" rng=Epf!A1 var=Co2.l rng=Co2!a1 text="Co2" rng=Co2!A1 var=Co2_dot.l rng=Co2_dot!a1 text="Co2_dot" rng=Co2_dot!A1';
execute 'gdxxrw.exe results50SLRdot33.gdx o=results50SLRdot33.xlsx var=RFCO2.l rng=RFCO2!a1 text="RFCO2" rng=RFCO2!A1 par=ERFx rng=ERFx!a1 text="ERFx" rng=ERFx!A1 var=ERF.l rng=ERF!a1 text="ERF" rng=ERF!A1';
execute 'gdxxrw.exe results50SLRdot33.gdx o=results50SLRdot33.xlsx var=miu.l rng=miu!a1 text="miu" rng=miu!A1  var=C.l rng=C!a1 text="C" rng=C!A1  var=Y.l rng=Y!a1 text="Y" rng=Y!A1  var=Kd.l rng=Kd!a1 text="Kd" rng=Kd!A1 var=Y.l rng=Y!a1 text="Y" rng=Y!A1';
execute 'gdxxrw.exe results50SLRdot33.gdx o=results50SLRdot33.xlsx var=Tatm.l rng=Tatm!a1 text="Tatm" rng=Tatm!A1  var=pH.l rng=pH!a1 text="pH" rng=pH!A1 var=a.l rng=a!a1 text="a" rng=a!A1 var=Td.l rng=Td!a1 text="Td" rng=Td!A1 var=T_dot.l rng=T_dot!a1 text="T_dot" rng=T_dot!A1 var=Td_dot.l rng=Td_dot!a1 text="Td_dot" rng=Td_dot!A1' ;
execute 'gdxxrw.exe results50SLRdot33.gdx o=results50SLRdot33.xlsx var=OHC.l rng=OHC!a1 text="OHC" rng=OHC!A1 var=OHC_dot.l rng=OHC_dot!a1 text="OHC_dot" rng=OHC_dot!A1 var=Hthx_dot.l rng=Hthx_dot!a1 text="Hthx_dot" rng=Hthx_dot!A1 var=Hgla_dot.l rng=Hgla_dot!a1 text="Hgla_dot" rng=Hgla_dot!A1 var=Hgis_dot.l rng=Hgis_dot!a1 text="Hgis_dot" rng=Hgis_dot!A1 var=Hais_dot.l rng=Hais_dot!a1 text="Hais_dot" rng=Hais_dot!A1 var=Hais_smb_dot.l rng=Hais_smb_dot!a1 text="Hais_smb_dot" rng=Hais_smb_dot!A1 var=Htot_dot.l rng=Htot_dot!a1 text="Htot_dot" rng=Htot_dot!A1 var=Hthx.l rng=Hthx!a1 text="Hthx" rng=Hthx!A1 var=Hgla.l rng=Hgla!a1 text="Hgla" rng=Hgla!A1 var=Hgis.l rng=Hgis!a1 text="Hgis" rng=Hgis!A1 var=Hais.l rng=Hais!a1 text="Hais" rng=Hais!A1 var=Hais_smb.l rng=Hais_smb!a1 text="Hais_smb" rng=Hais_smb!A1 var=Htot.l rng=Htot!a1 text="Htot" rng=Htot!A1' ;
execute 'gdxxrw.exe results50SLRdot33.gdx o=results50SLRdot33.xlsx par=lambdaC rng=lambdaC!a1 text="lambdaC" rng=lambdaC!A1  par=lambdaE rng=lambdaE!a1 text="lambdaE" rng=lambdaE!A1  par=Cprice rng=Cprice!a1 text="Cprice" rng=Cprice!A1  par=SCC rng=SCC!a1 text="false SCC" rng=SCC!A1  par=FOCuniC rng=FOCuniC!a1 text="FOCuniC" rng=FOCuniC!A1  par=FOCuniMIU rng=FOCuniMIU!a1 text="FOCuniMIU" rng=FOCuniMIU!A1  par=FOClambda rng=FOClambda!a1 text="FOClambda" rng=FOClambda!A1 par=mutil rng=marg_util!a1 text="marginal utility" rng=marg_util!A1' ;
execute 'gdxxrw.exe results50SLRdot33.gdx o=results50SLRdot33.xlsx var=utility.l rng=utility!a1 text="Utility" rng=utility!A1  var=Metautility.l rng=Metautility!a2 text="Metautility" rng=Metautility!A1' ;
...
execute_unload "results50SLRdot10.gdx"
execute 'gdxxrw.exe results50SLRdot10.gdx o=results50SLRdot10.xlsx text="Target Probability of staying below" rng=stats!a1 text="0.95" rng=stats!b1 text="Actual probability of staying below, Temp" rng=stats!a2 var=MaxTempCon.l rng=stats!b2 text="Actual probability of staying below, A" rng=stats!a3 var=MaxACon.l rng=stats!b3 text="Actual probability of staying below, pH" rng=stats!a4 var=MinpHCon.l rng=stats!b4 text="Damage Parameter" rng=stats!a5 var=a2d_var.l rng=stats!b5 text="Solution status" rng=stats!a6 par=solstat rng=stats!b6 text="modified DICE (yes if 1)" rng=stats!a7 par=ifmod rng=stats!b7 ' ;
execute 'gdxxrw.exe results50SLRdot10.gdx o=results50SLRdot10.xlsx var=Eind.l rng=Eind!a1 text="Eind" rng=Eind!A1 par=Etree rng=Etree!a1 text="Etree" rng=Etree!A1 var=ECO2.l rng=ECO2!a1 text="ECO2" rng=ECO2!A1 var=Fland.l rng=Fland!a1 text="Fland" rng=Fland!A1  var=Focean.l rng=Focean!a1 text="Focean" rng=Focean!A1 var=Epf.l rng=Epf!a1 text="Epf" rng=Epf!A1 var=Co2.l rng=Co2!a1 text="Co2" rng=Co2!A1 var=Co2_dot.l rng=Co2_dot!a1 text="Co2_dot" rng=Co2_dot!A1';
execute 'gdxxrw.exe results50SLRdot10.gdx o=results50SLRdot10.xlsx var=RFCO2.l rng=RFCO2!a1 text="RFCO2" rng=RFCO2!A1 par=ERFx rng=ERFx!a1 text="ERFx" rng=ERFx!A1 var=ERF.l rng=ERF!a1 text="ERF" rng=ERF!A1';
execute 'gdxxrw.exe results50SLRdot10.gdx o=results50SLRdot10.xlsx var=miu.l rng=miu!a1 text="miu" rng=miu!A1  var=C.l rng=C!a1 text="C" rng=C!A1  var=Y.l rng=Y!a1 text="Y" rng=Y!A1  var=Kd.l rng=Kd!a1 text="Kd" rng=Kd!A1 var=Y.l rng=Y!a1 text="Y" rng=Y!A1';
execute 'gdxxrw.exe results50SLRdot10.gdx o=results50SLRdot10.xlsx var=Tatm.l rng=Tatm!a1 text="Tatm" rng=Tatm!A1  var=pH.l rng=pH!a1 text="pH" rng=pH!A1 var=a.l rng=a!a1 text="a" rng=a!A1 var=Td.l rng=Td!a1 text="Td" rng=Td!A1 var=T_dot.l rng=T_dot!a1 text="T_dot" rng=T_dot!A1 var=Td_dot.l rng=Td_dot!a1 text="Td_dot" rng=Td_dot!A1' ;
execute 'gdxxrw.exe results50SLRdot10.gdx o=results50SLRdot10.xlsx var=OHC.l rng=OHC!a1 text="OHC" rng=OHC!A1 var=OHC_dot.l rng=OHC_dot!a1 text="OHC_dot" rng=OHC_dot!A1 var=Hthx_dot.l rng=Hthx_dot!a1 text="Hthx_dot" rng=Hthx_dot!A1 var=Hgla_dot.l rng=Hgla_dot!a1 text="Hgla_dot" rng=Hgla_dot!A1 var=Hgis_dot.l rng=Hgis_dot!a1 text="Hgis_dot" rng=Hgis_dot!A1 var=Hais_dot.l rng=Hais_dot!a1 text="Hais_dot" rng=Hais_dot!A1 var=Hais_smb_dot.l rng=Hais_smb_dot!a1 text="Hais_smb_dot" rng=Hais_smb_dot!A1 var=Htot_dot.l rng=Htot_dot!a1 text="Htot_dot" rng=Htot_dot!A1 var=Hthx.l rng=Hthx!a1 text="Hthx" rng=Hthx!A1 var=Hgla.l rng=Hgla!a1 text="Hgla" rng=Hgla!A1 var=Hgis.l rng=Hgis!a1 text="Hgis" rng=Hgis!A1 var=Hais.l rng=Hais!a1 text="Hais" rng=Hais!A1 var=Hais_smb.l rng=Hais_smb!a1 text="Hais_smb" rng=Hais_smb!A1 var=Htot.l rng=Htot!a1 text="Htot" rng=Htot!A1' ;
execute 'gdxxrw.exe results50SLRdot10.gdx o=results50SLRdot10.xlsx par=lambdaC rng=lambdaC!a1 text="lambdaC" rng=lambdaC!A1  par=lambdaE rng=lambdaE!a1 text="lambdaE" rng=lambdaE!A1  par=Cprice rng=Cprice!a1 text="Cprice" rng=Cprice!A1  par=SCC rng=SCC!a1 text="false SCC" rng=SCC!A1  par=FOCuniC rng=FOCuniC!a1 text="FOCuniC" rng=FOCuniC!A1  par=FOCuniMIU rng=FOCuniMIU!a1 text="FOCuniMIU" rng=FOCuniMIU!A1  par=FOClambda rng=FOClambda!a1 text="FOClambda" rng=FOClambda!A1 par=mutil rng=marg_util!a1 text="marginal utility" rng=marg_util!A1' ;
execute 'gdxxrw.exe results50SLRdot10.gdx o=results50SLRdot10.xlsx var=utility.l rng=utility!a1 text="Utility" rng=utility!A1  var=Metautility.l rng=Metautility!a2 text="Metautility" rng=Metautility!A1' ;
