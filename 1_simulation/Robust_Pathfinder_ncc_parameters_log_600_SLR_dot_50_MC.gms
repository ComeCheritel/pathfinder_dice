...
**  - the Monte Carlo simulation with a constraint limiting sea-level rise speed to 5.0 mm per year
...
$offecho
$call gdxxrw i=par_v1_50SLR_dot_MC.xlsx o=par_m.gdx @par_m.tab
...
$offecho
$call gdxxrw i=ini_2015_v1_50SLR_dot_MC.xlsx o=ini_m.gdx @ini_m.tab
...
$offecho
$call gdxxrw i=ERFx_for_dice_2_50SLR_dot_MC.xlsx o=ERFx_for_dice.gdx @ERFx_for_dice.tab
...
$offecho
$call gdxxrw i=Eluc_for_dice_2_50SLR_dot_MC.xlsx o=Eluc_for_dice.gdx @Eluc_for_dice.tab
...
** setting penalty paramers for sea-level rise speed above 5.0 mm/year
penSLR_dot1=10**9; tarSLR_dot1 = 5.0 ;
...
File NiceSSLR_dot50 /NiceSSLR_dot50.txt/;
NiceSSLR_dot50.pc=5;
NiceSSLR_dot50.pw=32767;
Put NiceSSLR_dot50;
...
*MetaUtility.l = 1/Card(m) * ( Sum(m, (utility.l(m)/ scale1)**(1-chi) )  )**(1/(1-chi)) ;
...
Htot_dot.up(m,t) = max(5.0, SLR_dotmax(m));
...
execute_unload "resultsMC50SLR_dot.gdx"
execute 'gdxxrw.exe resultsMC50SLR_dot.gdx o=resultsMC50SLR_dot.xlsx text="Damage Parameter" rng=stats!a3 var=a2d_var.l rng=stats!b3 text="Solution status" rng=stats!a4 par=solstat rng=stats!b4 text="modified DICE (yes if 1)" rng=stats!a5 par=ifmod rng=stats!b5 text="population" rng=stats!a6 par=l rng=stats!b6 ' ;
execute 'gdxxrw.exe resultsMC50SLR_dot.gdx o=resultsMC50SLR_dot.xlsx var=Eind.l rng=Eind!a1 text="Eind" rng=Eind!A1 par=Etree rng=Etree!a1 text="Etree" rng=Etree!A1 var=ECO2.l rng=ECO2!a1 text="ECO2" rng=ECO2!A1 var=Fland.l rng=Fland!a1 text="Fland" rng=Fland!A1  var=Focean.l rng=Focean!a1 text="Focean" rng=Focean!A1 var=Epf.l rng=Epf!a1 text="Epf" rng=Epf!A1 var=Co2.l rng=Co2!a1 text="Co2" rng=Co2!A1 var=Co2_dot.l rng=Co2_dot!a1 text="Co2_dot" rng=Co2_dot!A1';
execute 'gdxxrw.exe resultsMC50SLR_dot.gdx o=resultsMC50SLR_dot.xlsx var=RFCO2.l rng=RFCO2!a1 text="RFCO2" rng=RFCO2!A1 par=ERFx rng=ERFx!a1 text="ERFx" rng=ERFx!A1 var=ERF.l rng=ERF!a1 text="ERF" rng=ERF!A1';
execute 'gdxxrw.exe resultsMC50SLR_dot.gdx o=resultsMC50SLR_dot.xlsx var=miu.l rng=miu!a1 text="miu" rng=miu!A1  var=C.l rng=C!a1 text="C" rng=C!A1  var=Y.l rng=Y!a1 text="Y" rng=Y!A1  var=Kd.l rng=Kd!a1 text="Kd" rng=Kd!A1 var=Y.l rng=Y!a1 text="Y" rng=Y!A1';
...
execute 'gdxxrw.exe resultsMC50SLR_dot.gdx o=resultsMC50SLR_dot.xlsx var=utility.l rng=utility!a1 text="Utility" rng=utility!A1  var=Metautility.l rng=Metautility!a2 text="Metautility" rng=Metautility!A1' ;
